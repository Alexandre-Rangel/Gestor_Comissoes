      ...
      <div class="modal-body">
        ...
        <form id="formulario">
          ...
          <div class="form-group col-lg-15">
            ...
            <input class="form-control" required name="nome" id="nome" type="text">
          </div>
          <div class="form-group col-lg-15">
            <label for="usuario">Data de Entrada</label>
            <input class="form-control" required name="data" id="data" type="text">
          </div>
          <div class="form-group col-lg-15">
...
<script src="js/Vendedor/Vendedor_Grid.js"></script>
<script src="js/Vendedor/Vendedor_CRUD.js"></script>
